    ...
    return (
        <main className="main-container">
            { !taskData && <div className={`task-not-found-container centered-flex-col-container`}>
                ...
                <Link to="/tasks"><button className="btn btn-outline-default ">{"<- Back To Tasks"}</button></Link>
            </div> }

            { taskData && <div className="pomodoro-task-section  flex-col-container">
                <section>
                    <div className="timer-container">
                        <div className="return-task-page-container">
                            <Link to="/tasks">
                                <button className="btn return-to-task-page-btn btn-icon-primary  space-S">
                        ...
                        <div className="timer-controls">
                            ...
                            <button className="btn timer-control-btn start-btn btn-icon-primary space-S" onClick={() => setIsPlaying(true)}>
                                <FontAwesomeIcon icon={faPlay} className="control-icons"/>
                                START
                            </button>
                            <button className="btn timer-control-btn stop-btn btn-icon-primary  space-S" onClick={() => setIsPlaying(false)}>
                                <FontAwesomeIcon icon={faPause} className="control-icons" />
                                STOP
                            </button>
                            <button className="btn timer-control-btn restart-btn btn-icon-primary  space-S" onClick={() => setKey((prevKey) => prevKey + 1)}>
